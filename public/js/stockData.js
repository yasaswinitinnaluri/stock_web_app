function nyse() {
    /*     uncheckAll("nyse");
        uncheckAll("nasdaq"); */
    document.getElementById("DISPLAYNYSE").style.display = "block";
    document.getElementById("DISPLAYNASDAQ").style.display = "none";
}

function nasdaq() {
    /*     uncheckAll("nyse");
        uncheckAll("nasdaq"); */
    document.getElementById("DISPLAYNASDAQ").style.display = "block";
    document.getElementById("DISPLAYNYSE").style.display = "none";
}

function getSelectItemThat(id, x) {
